...
#git pull
    mkdir /home/kops/setup
    cd /home/kops/setup || exit
    sudo git init
    sudo git clone https://github.com/TMRDevOps/terrasetup.git
    sudo chmod 777 -R /home/kops/setup/
    sudo chmod 777 -R /home/kops/setup/*
    sudo chown nobody:nogroup -R /home/kops/setup/*
    sudo chown nobody:nogroup -R /home/kops/setup/
...
curl -fsSL https://download.docker.com/linux/kops/gpg | sudo gpg --dearmor -o /etc/apt/keyrings/docker.gpg

#Use follwing command to set up the repository:

echo \
  "deb [arch=$(dpkg --print-architecture) signed-by=/etc/apt/keyrings/docker.gpg] https://download.docker.com/linux/kops \
